...
export const DEMO_PUBLIC_PROFILE: PublicProfile = {
  ...
  social_links: [
    { platform: "linkedin", value: DEMO_USER_PROFILE.social.linkedin },
    { platform: "instagram", value: DEMO_USER_PROFILE.social.instagram },
    { platform: "twitter", value: DEMO_USER_PROFILE.social.twitter },
    { platform: "website", value: DEMO_USER_PROFILE.social.website },
  ],
  education: [],
  experience: [],
  achievements: [],
